...
import {
  billingBalanceRequestSchema, billingGoUsageRequestSchema, billingTodayUsageRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'billing.balance': { schema: billingBalanceRequestSchema, invoke: (api, r, signal) => api.billing.balance(r, signal) },
  'billing.todayUsage': { schema: billingTodayUsageRequestSchema, invoke: (api, r, signal) => api.billing.todayUsage(r, signal) },
  'billing.goUsage': { schema: billingGoUsageRequestSchema, invoke: (api, r, signal) => api.billing.goUsage(r, signal) },
}
