...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-token-usage': { kind: 'none', reason: 'Browser-side read-only projection of host billing facts; the host billing domain and provider adapters own any model-facing behavior.' },
